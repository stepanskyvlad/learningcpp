...
// Stack Unwinding
/**
 * if func_c throws an error and we catch the error only in main, 
 * func_b and func_a won't finish correctly.
 * If we catch the error of the func_c in the place where we call this func - other code will work properly.
 */
#include <iostream>
